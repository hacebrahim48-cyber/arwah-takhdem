...
class FeatureScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    switch (title) {
      case 'أبحث عن عمل':
        page = const SearchJobsPage();
        break;

      case 'أبحث عن عامل':
        page = const SearchWorkersPage();
        break;
...
class _SearchJobsPageState extends State<SearchJobsPage> {
  ...
  Widget build(BuildContext context) {
    return FilterPage(
      title: 'البحث عن فرص العمل',
      firstLabel: 'المهنة أو الوظيفة',
      firstValue: job,
      firstItems: professions,
      secondLabel: 'الولاية',
      secondValue: wilaya,
      secondItems: wilayas,
      button: 'بحث عن فرص العمل',
      onFirst: (v) {
        setState(() => job = v);
      },
      onSecond: (v) {
      ...
      result: searched
          ? 'تم البحث عن «${job ?? 'كل المهن'}» '
              '${wilaya == null ? 'في جميع الولايات' : 'في ولاية $wilaya'}\n\n'
              'ستظهر النتائج الحقيقية بعد ربط قاعدة البيانات.'
          : null,
    );
  }
}
...
class _SearchWorkersPageState extends State<SearchWorkersPage> {
  ...
  Widget build(BuildContext context) {
    return FilterPage(
      title: 'البحث عن عامل',
      firstLabel: 'المهنة المطلوبة',
      firstValue: job,
      firstItems: professions,
      secondLabel: 'الولاية',
      secondValue: wilaya,
      secondItems: wilayas,
      button: 'بحث عن العمال',
      onFirst: (v) {
        setState(() => job = v);
      },
      onSecond: (v) {
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        ChoiceTile(
          label: firstLabel,
          value: firstValue ?? 'اختر من القائمة',
          items: firstItems,
          onChanged: onFirst,
        ),
        ChoiceTile(
          label: secondLabel,
          value: secondValue ?? 'اختر الولاية',
          items: secondItems,
          onChanged: onSecond,
        ),
...
class _ProjectsPageState extends State<ProjectsPage> {
  ...
  @override
  Widget build(BuildContext context) {
    final shown = projects.where(
      (p) =>
          (category == null || p[1] == category) &&
          (wilaya == null || p[2] == wilaya),
    ).toList();
    ...
    return ListView(
      ...
      children: [
        ...
        const Text(
          'قائمة موسعة مع البحث في المجالات والولايات والميزانية.',
        ),
        const SizedBox(height: 18),

        ChoiceTile(
          label: 'مجال المشروع',
          value: category ?? 'اختر مجال المشروع',
        ...
        ChoiceTile(
          label: 'الميزانية',
          value: budget ?? 'اختر نطاق الميزانية',
          items: const [
            'أقل من 1,000,000 دج',
            '1,000,000 - 5,000,000 دج',
            '5,000,000 - 20,000,000 دج',
            '20,000,000 - 50,000,000 دج',
            '50,000,000 - 100,000,000 دج',
            'أكثر من 100,000,000 دج',
          ],
          onChanged: (v) {
            setState(() => budget = v);
          },
      ...
      body: Directionality(
        ...
        child: ListView(
          ...
          children: [
            ...
            const Text(
              'تفاصيل المشروع، احتياجات التمويل، مدة الإنجاز '
              'ونسبة التمويل المطلوبة ستضاف عند ربط قاعدة البيانات.',
            ),
            ...
            FilledButton.icon(
              onPressed: () {
                _snack(
                  context,
                  'تم تسجيل اهتمامك بالمشروع',
                );
              },
              icon: const Icon(Icons.favorite_border),
              label: const Text('أنا مهتم'),
            ),
            ...
            OutlinedButton.icon(
              onPressed: () {
                _snack(
                  context,
                  'يمكن فتح المحادثة بعد ربطها بقاعدة البيانات',
                );
              },
...
class _InvestorsPageState extends State<InvestorsPage> {
  ...
  @override
  Widget build(BuildContext context) {
    final shown = investors.where(
      (i) =>
          (category == null || i[1] == category) &&
          (wilaya == null || i[2] == wilaya),
    ).toList();
    ...
    return ListView(
      ...
      children: [
        ...
        const Text(
          'قائمة موسعة لمجالات الاستثمار مع الولاية والمبلغ.',
        ),
        ...
        ChoiceTile(
          ...
          value: amount ?? 'اختر قيمة الاستثمار',
          items: const [
            'أقل من 5,000,000 دج',
            '5,000,000 - 20,000,000 دج',
            '20,000,000 - 50,000,000 دج',
...
class InvestorDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('تفاصيل المستثمر'),
      ),
      body: Directionality(
        textDirection: TextDirection.rtl,
        child: ListView(
          ...
          children: [
            ...
            Text('مجال الاستثمار: ${i[1]}'),
            Text('الولاية: ${i[2]}'),
            Text('قيمة الاستثمار: ${i[3]}'),
            ...
            const Text(
              'ملف المستثمر وتفضيلاته وشروط التمويل '
              'ستظهر هنا عند ربط قاعدة البيانات.',
            ),
            ...
            FilledButton.icon(
              ...
              icon: const Icon(Icons.chat),
              label: const Text('تواصل مع المستثمر'),
            ),
          ],
        ),
      ),
  ...
  Widget build(BuildContext context) {
    return const SimplePage(
      ...
      text:
          ...
          'ستظهر هنا طلبات العمل والتواصل والتمويل.',
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return const SimplePage(
      ...
      text:
          ...
          'ستظهر هنا محادثاتك مع العمال وأصحاب المشاريع والمستثمرين.',
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return const SimplePage(
      ...
      text:
          ...
          'ستظهر هنا إشعارات الطلبات والرسائل والمشاريع.',
    );
  }
}
      ...
      children: [
        ...
        Card(
          child: ListTile(
            ...
            title: const Text('المهنة والمهارات'),
            subtitle: const Text(
              'اختر مهنتك أو اكتب مهنة أخرى',
            ),
            onTap: () async {
              final value = await Navigator.push<String>(
                context,
                MaterialPageRoute(
                  builder: (_) => const ChoicePicker(
